...
export function TaskReportPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['report-tasks', { projectId, assigneeId, status, priority }],
    queryFn: () => reportsApi.tasks({
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Breakdown of internal tasks by status, priority, project and assignee</p>
      </div>
